...
async def reply(client, message): 
    try:
        ...
        await message.reply(f"{Config.REPLY_MESSAGE}\n\n<b>You can't use this bot in your group, for that you have to add your group to database, please contact @trtechguide to add your group.</b>", disable_web_page_preview=True)
