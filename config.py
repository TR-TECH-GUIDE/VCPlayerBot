...
Y_PLAY=False
YSTREAM=False
STREAM=os.environ.get("STARTUP_STREAM", "https://www.youtube.com/watch?v=RMrltvVlYAY")
...
<b>How Can I Stream In My Group</b>
  <i>To use bot in your group, add your group to database, please contact @trtechguide to add your group..</i>
