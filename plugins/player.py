...
async def notforu(_, m: Message):
    await _.send_cached_media(chat_id=m.chat.id, file_id="CAADBQADEgQAAtMJyFVJOe6-VqYVzAI", caption="You Are Not Authorized", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('⚡️Join Here', url='https://t.me/SLBotsOfficial')]]))
...
async def not_chat(_, m: Message):
    buttons = [
        [
            InlineKeyboardButton('⚡️Add Your Group', url='https://t.me/trtechguide'),
            InlineKeyboardButton('🧩 Join Here', url='https://t.me/SLBotsOfficial'),
        ]
        ]
    await m.reply("<b>You can't use this bot in this group, for that you have to add your group to database, please contact @trtechguide to add your group.</b>", disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup(buttons))
